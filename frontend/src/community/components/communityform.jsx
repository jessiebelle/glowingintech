...
export default function SignUp() {
  ...
  return (
    <Container component="main" maxWidth="xs">
      ...
      <div className={classes.paper}>
        ...
        <form className={classes.form} noValidate>
          <Grid container spacing={2}>
            ...
            <Grid item xs={12}>
              <FormControlLabel
                control={<Checkbox value="allowSlackInvitation" color="primary" />}
                label="I want to join the slack community."
              />
            </Grid>
          </Grid>
      ...
      <div>
        <iframe
          src="https://glowingintech.substack.com/embed"
          width="480"
          height="320"
          title={'substack sign up'}
        ></iframe>
      </div>
      <Box mt={5}></Box>
    </Container>
