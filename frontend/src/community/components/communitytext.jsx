...
const CommunityText = () =>{
  return (
      <div>
        ...
        <Typography className={styles.communityText} variant="h4" component="div" gutterBottom>Community is <b>essential</b> for personal and professional growth. </Typography>
   <YoutubeEmbed embedId="uPCA9q_kbwA" />
            <Typography className={styles.communityText} variant="h6" align="justify">Everyone is welcome to join the Glowing in Tech community</Typography>
    <Typography variant="body1" align="justify" gutterBottom className={styles.communityText}>
    ...
    <Typography className={styles.communityText} variant="h6" align={"justify"} gutterBottom> What to expect: </Typography>
        <Typography className={styles.communityText} variant="body1" align="justify" gutterBottom>
