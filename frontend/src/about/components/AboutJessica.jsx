  ...
  return (
    <div>
      ...
      <Typography className={styles.text} variant="h6" align="left">
        Ops Engineer & Head of Technical Writing{' '}
      </Typography>
      <Typography className={styles.text} variant="body1" align="left" gutterBottom>
        Jessica is an IT Operations Engineer at CybSafe. She speaks and writes about the
        human implications of engineering decisions for a selection of tech publications
        and works as a co-organiser of DevOpsDays London and the regular meetup group
        DevSecOps London Gathering. She also works with Coding Black Females to improve
        equal and equitable representation within the technology industry.
      </Typography>
      <IconButton
        edge="start"
        aria-label="Twitter"
