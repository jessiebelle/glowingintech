    ...
    <div style={{ backgroundColor: '#351c75ff' }}>
      <div className={styles.bg}>
        <Box className={styles.box}>
          <Typography className={styles.text} variant="h3" component="div" gutterBottom>
            Meet the Team
          </Typography>
          <Typography variant={'h5'} align={'left'} className={styles.aboutheader}>
            We're a group of engineers taking on the digital skills shortage and lack of
