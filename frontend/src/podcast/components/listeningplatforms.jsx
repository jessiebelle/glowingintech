...
const platforms = [
  {
    logo: applepodcast,
    pageTitle: 'Apple Podcast',
    href: 'https://podcasts.apple.com/us/podcast/glowing-in-tech-the-showcase/id1626097038',
  },
  {
    logo: spotify,
    pageTitle: 'Spotify',
    href: 'https://open.spotify.com/show/7av07hbwZWBUGTQmG3Vaxi',
  },
  {
    logo: googlepodcast,
    pageTitle: 'Google Podcast',
    href: 'https://podcasts.google.com/feed/aHR0cHM6Ly9hbmNob3IuZm0vcy84YzkyZTg3MC9wb2RjYXN0L3Jzcw',
  },
  { logo: anchor, pageTitle: 'Anchor', href: 'https://anchor.fm/glowing-in-tech' },
  {
    logo: amazonmusic,
    pageTitle: 'Amazon Music',
    href: 'https://music.amazon.co.uk/podcasts/00c6fb98-026a-4023-8a59-c12b31317723/glowing-in-tech-the-showcase?refMarker=null&',
  },
  {
    logo: youtube,
    pageTitle: 'YouTube',
    href: 'https://www.youtube.com/channel/UCZ8JZ5YXZQZ9Z5Z4ZQZ9Z5Z4',
  },
]
  ...
  return (
    <div className={styles.carousel}>
      <Box sx={{ flexGrow: 1, margin: 'auto', padding: 5, width: '80%' }}>
              ...
              <Grid item xs key={index} alignItems="center">
                ...
                >
                  <picture className={styles.platformpicture}>
                    ...
                    <img
                      src={platform.logo}
                      alt={platform.pageTitle}
                      className={styles.platformpicture}
                    />
                  </picture>
                </Item>
              </Grid>
        ...
        <Typography variant={'h4'} align={'left'} fontWeight={10}>
          <br />
          <Link href={'https://lnk.to/glowingintech'}>
            Click here for a full list of streaming platforms{' '}
          </Link>
        </Typography>
      </Box>
    </div>
