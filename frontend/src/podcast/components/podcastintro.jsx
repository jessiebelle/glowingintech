...
const PodcastIntro = () => {
    ...
    <div className={styles.introdiv}>
                ...
                width: '80%',
                    ...
                    <Typography variant={"h3"} align={"left"} gutterBottom className={styles.text}> Our story so far</Typography>
...
With season 2, we aim to provide deep dives into career development topics, from underrepresented people, to provide honest insight into different career routes and grow our audience across platforms.
                    ...
                    <br/>
      <Typography variant={'h5'} align={"left"} gutterBottom className={styles.text}> We want to provide a safe platform for marginalised voices in the tech industry to share their experiences and insights. By showcasing the unique perspectives and career paths of people of colour, women, neurodivergent and disabled people, the podcast hopes to inspire and encourage others to pursue careers in tech.</Typography>
